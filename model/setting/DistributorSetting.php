...
if (isset($_POST ["add"]) || isset($_POST ["modify"])) {
    ...
    $dis_province = $_POST ['select_province'];
    $dis_city = $_POST ['select_city'];
    $dis_zone = $_POST ['select_zone'];
    $dis_address = $_POST ['address'];
    $dis_star = $_POST ['star'];
    $dis_phone = $_POST ['phone'];
    $dis_lat = $_POST ['lat'];
    $dis_lon = $_POST ['lon'];
    $dis_introduce = $_POST ['introduce '];
